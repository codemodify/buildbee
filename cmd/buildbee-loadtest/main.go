...
func main() {
	...
	flag.IntVar(&o.Bots, "bots", 5, "Bots to create, each with its own agent")
	flag.IntVar(&o.Slots, "slots", 4, "Runs each Bot takes at once")
	...
	fmt.Fprintf(os.Stderr, "%d runs through %d bots x %d slots against %s\n", o.Runs, o.Bots, o.Slots, o.Server)
